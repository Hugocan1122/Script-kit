...
def get_params():
    params = {
        'weight': 'D:/dataset/01_all_models/tfds_cejia_det.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'HiResCAM',
...
if __name__ == '__main__':
    ...
    model(r'D:\dataset\tfds_demos', r'E:\pythonProject\ultralytics-8.1.0\tfds_heatmap_det')